...
The new suite's 32 failures are intentional acceptance reds. The existing 43
observer/launcher/admission/adapter checks remain green, showing that the
test-only package changes no production behavior.
